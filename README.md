...
This project is an Arduino-based temperature and humidity sensor using a DHT sensor and an I2C LCD for display. The project
includes the necessary libraries, schematic files, and an Arduino sketch. 
...
## Schematic 
The schematic for wiring the components can be found on the `Schematic.jpg` file. 
You can also find the Fritzing schematic file `Schematic.fzz` in the repository for more detailed information. 

## Contributing 
If you would like to contribute to this project, please fork the repository and submit a pull request. For major changes, please open
an issue first to discuss what you would like to change. 

## Contact
If you have any questions or suggestions, feel free to contact me at 6.6onke@gamil.com
